        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="mb-6 mt-2">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white">Adição Rápida</h3>
              <p className="text-sm text-gray-500 dark:text-slate-400">
                Digite os códigos das figurinhas separados por vírgula ou espaço.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="flex w-full items-center justify-center space-x-2 rounded-2xl bg-blue-600 py-4 font-bold text-white shadow-lg shadow-blue-500/30 transition-transform active:scale-[0.98]"
              >
